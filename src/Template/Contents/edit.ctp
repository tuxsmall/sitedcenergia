<section class="page-section">
    <div class="container-fluid">
        <h5 class="text-center text-uppercase text-secondary mt-5">Editando Post</h5>
        <!-- Icon Divider-->
            ...
            <div class="col-lg-2 mx-auto">
                <div class="card d-none d-lg-block" style="width: 18rem;">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">
                            <a class="text-center" href="<?php echo $this->Url->build('/contents/add', true);?>"><i class="fas fa-caret-right"></i> Novo Post</a>
                        </li>
                        <li class="list-group-item">
