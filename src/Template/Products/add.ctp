<section class="page-section" id="contact">
    <div class="container-fluid">
        <h2 class="page-section-heading text-center text-uppercase text-secondary mt-4">Novo Produto</h2>
        <!-- Icon Divider-->
...
<br>
                    ...
                    <!--FIM-->
                    <br>
                    <div class="form-group"><button class="btn btn-primary btn-xl btn-block" type="submit">Salvar produto</button></div>
                <?= $this->Form->end() ?>
            </div>
        </div>
    </div>
