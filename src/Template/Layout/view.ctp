...
<head>
  ...
  <?= $this->Html->css(['/publico/css/bootstrap.min.css','/publico/css/estilo.css']) ?>
  ...
  <meta name="keywords" content="dc energia, painel solar, renovável, sustentável, fotovoltaico, inovação, eficiência, solaire, sustentabilidade, tecnologia limpa, captação solar, energia verde, energia renovável, emissão zero, geração solar, sistemas fotovoltaicos," />
...
<body>
  ...
  <?php if(!$this->request->getAttribute("here") == '/kits-solares'){?>
  ...
  <?php echo $this->Html->script([
            '/publico/js/jquery.min.js','/publico/js/bootstrap.bundle.min.js','/publico/js/cookies.js','/publico/js/animacao.js','/publico/js/splide.min.js'
			])
		?>
