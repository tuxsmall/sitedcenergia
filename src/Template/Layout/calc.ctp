...
<body>
  ...
  <div class="home" id="home">
    <?= $this->fetch('content') ?>
    <?php //echo $this->element('formcalc');?>
  </div>
  ...
  <?php echo $this->Html->script([
            '/publico/js/jquery.min.js','/publico/js/bootstrap.bundle.min.js','/publico/js/cookies.js','/publico/js/animacao.js','/publico/js/ajax.js','/publico/js/mask.js'
			])
		?>
